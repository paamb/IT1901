...
public class MovieListTest {
  ...
  public void setUp() {
    ...
    movie1 = new Movie("tittel", "desc", 1, true, new ArrayList<>());
    movie2 = new Movie("tittel", "descasdas", 2, false, new ArrayList<>());
    movie3 = new Movie("tittela", "descasdas", 3, false, new ArrayList<>());
  }
  ...
  public void testIterator_AddAndRemove() {
    ...
    Movie movie4 = new Movie("title", "description", 3, true, new ArrayList<>());
